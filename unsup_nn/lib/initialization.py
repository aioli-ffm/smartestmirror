...
class WeightInit:
    ...
    def __init__(self, init_scheme):
        ...
        self.init_methods_dict = {'xavier-normal': init.xavier_normal,
                             'xavier-uniform': init.xavier_uniform,
                             'kaiming-normal': init.kaiming_normal,
                             'kaiming-uniform': init.kaiming_uniform}
